...
const CONFIG = Object.freeze({
  withdraw: {
    ...
    normal_min:   0.03,   // السحب الطبيعي — USDT
    normal_level: 5,      // المستوى المطلوب للسحب الطبيعي
  },
  rewards: {
    referral:          0.005,   // USDT لكل إحالة
    telegram_task:     200,
    adsgram_task:      50,
    daily_ads_10:      200,
    daily_ads_25:      300,
    ...
    usdt_per_ad:       0.001,  // USDT لكل إعلان Adsgram
  },
  telegram: {
  ...
  monetag: {
    daily_limit:   2500,    // الحد اليومي لـ Monetag
...
const CFG = {
  ...
  RISK_BAN:              160,   // رُفع من 100 → 160 لتقليل false positives
  RISK_SHADOW:           110,   // رُفع من 80 → 110
  ...
  // ── Multi-account — relaxed for shared IPs/devices ──────────
  MULTI_ACCT: {
    MAX_PER_IP: 2,   // ✅ 3 حسابات من نفس IP (WiFi مشترك / NAT)
    MAX_PER_FP: 1,   // ✅ 2 حسابات من نفس device fingerprint (عائلة)
