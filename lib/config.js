...
const CONFIG = Object.freeze({
  ...
  rewards: {
    ...
    daily_referrals_3: 500,  // 3 إحالات يومية
    points_per_ad:     40,    // نقاط لكل إعلان
  },
  telegram: {
    channel_url: 'https://t.me/botbababab',
  },
  ads: {
    daily_limit:       40,     // الحد اليومي للإعلانات العادية
    cooldown_ms:       30 * 1000,
