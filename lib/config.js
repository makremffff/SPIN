...
const CONFIG = Object.freeze({
  ...
  ads: {
    daily_limit:       500,     // الحد اليومي للإعلانات العادية
    cooldown_ms:       30 * 1000,
  ...
  adsgram_task: {
    ...
    daily_limit:       3,      // عدد مرات المهمة الإعلانية في اليوم
...
module.exports = { BOT_TOKEN, CHANNEL_ID, ADMIN_SECRET, IP_SALT, IS_DEV, CONFIG, CFG };
