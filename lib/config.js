...
const CONFIG = Object.freeze({
  ...
  rewards: {
    referral:          2000,   // تذاكر مسابقة لكل إحالة (بدل 100 نقطة)
    ...
    points_per_ad:     500,    // نقاط لكل إعلان
  },
  telegram: {
  ...
  competition: {
    ticket_per_ad:     50,   // عدد التذاكر لكل إعلان Monetag — ديناميكي من السيرفر
    daily_limit:       500,  // أقصى تذاكر في اليوم للمستخدم
    max_grant:         50,   // أقصى تذاكر في عملية منح واحدة
  },
});
...
const CFG = {
  ...
  COMPETITION_TICKET_PER_AD:       CONFIG.competition.ticket_per_ad,
  COMPETITION_MAX_TICKETS_PER_DAY: CONFIG.competition.daily_limit,
  COMPETITION_MAX_GRANT_PER_CALL:  CONFIG.competition.max_grant,
