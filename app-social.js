...
function _scStartBtn(taskId, reward) {
  ...
  return `<div class="c-start">
    <span class="start-pts">${Number(reward).toLocaleString(undefined,{minimumFractionDigits:0,maximumFractionDigits:4})}<img class="coin-img" src="asesst/dollar.png" alt="" onerror="this.src='asesst/dollar.png'"></span>
  ...
  document.getElementById('sheet-content').innerHTML = `
    <div class="sheet-head">
      ...
      <div class="sheet-pts-badge">
        <span class="sheet-pts-num">${Number(task.reward).toLocaleString(undefined,{minimumFractionDigits:0,maximumFractionDigits:4})}<img src="asesst/dollar.png" onerror="this.src='asesst/dollar.png'" alt="" style="width:18px;height:18px;object-fit:contain;filter:drop-shadow(0 1px 4px rgba(99,220,130,.4))"></span>
