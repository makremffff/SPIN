        ...
        // ══════════════════════════════════════════════════════════
        var _adController      = null;
        var _adWatchStartedAt  = 0;   // timestamp لبداية الإعلان — anti-fraud
        var _adRetryCount      = 0;
        var AD_MAX_RETRIES   = 2;
        var AD_MIN_DURATION  = 7000;  // 7s minimum client-side check
        ...
        var _adsgramTaskInProgress = false;
        ...
        var BOT_USERNAME = 'RebhApp_bot';

        // متغير عالمي للرابط — يُحدَّث من initTelegramUser()
        var REFERRAL_LINK = 'https://t.me/' + BOT_USERNAME + '?start=ref_0000000000';
        ...
        var _channelJoined = {}; // channelId → true (تم الضغط على انضم)
